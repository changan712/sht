define("sht/bmaps/1.0.0/bmaps-debug", [ "arale/class/1.1.0/class-debug" ], function(require, exports, module) {
    window.BMap_loadScriptTime = new Date().getTime();
    window.BMAP_AUTHENTIC_KEY = "OcwrIdQQjdm0lH2GbYWYk8dQ";
    (function() {
        ...
        8 > t.N.V ? (ia["for"] = "htmlFor", ia["class"] = "className") : (ia.htmlFor = "for", 
        ia.className = "class");
        t.B.lw = ia;
        ...
        t.B.mi.filter = function(a, b, c) {
            for (var d = 0, e = t.B.mi, f; f = e[d]; d++) if (f = f[c]) b = f(a, b);
            return b;
        };
        t.Lh.VB = function(a) {
        ...
        t.B.zg = function(a, b) {
            var c = t.B, a = c.Q(a), b = t.Lh.VB(b), d = a.style[b];
            if (!d) var e = c.Bs[b], d = a.currentStyle || (t.N.V ? a.style : getComputedStyle(a, n)), d = e && e.get ? e.get(a, d) : d[e || b];
        ...
        t.B.da = function(a) {
            var a = t.B.Q(a), b = t.B.Wt(a), c = t.N, d = t.B.zg;
        ...
        t.lang.ra.prototype.removeEventListener = function(a, b) {
            if (t.lang.Sm(b)) b = b.cA; else if (!t.lang.ue(b)) return;
            !this.cg && (this.cg = {});
            a.indexOf("on") != 0 && (a = "on" + a);
            var c = this.cg;
        ...
        t.lang.ra.prototype.dispatchEvent = function(a, b) {
            t.lang.ue(a) && (a = new t.lang.Jq(a));
            !this.cg && (this.cg = {});
            var b = b || {}, c;
            for (c in b) a[c] = b[c];
            var d = this.cg, e = a.type;
        ...
        t.Ht = function() {
            function a(a) {
                document.addEventListener && (this.element = a, this.zz = this.Zi ? "touchstart" : "mousedown", 
                this.Kt = this.Zi ? "touchmove" : "mousemove", this.Jt = this.Zi ? "touchend" : "mouseup", 
                this.Pu = o, this.KB = this.JB = 0, this.element.addEventListener(this.zz, this, o), 
                ha.D(this.element, "mousedown", p()), this.handleEvent(n));
            }
            a.prototype = {
        ...
        var ma = window.BMap_loadScriptTime, na = new Date().getTime(), oa = n, pa = i, qa = n;
        function ra(a, b) {
            if (a = t.Q(a)) {
                var c = this;
                t.lang.ra.call(c);
                ...
                var d = c.G.GG;
                if (F()) for (var e = 0, f = d.length; e < f; e++) if (t.N[d[e]]) {
        ...
        t.extend(ra.prototype, {
            ...
            Zg: function(a, b, c, d) {
                var e = this.ha().Ib(this.T()), f = this.bd, g = i;
                c && G.oA(c) && (this.Pe = new G(c.lng, c.lat), g = o);
                if (c = c && d ? f.ej(c, this.wb) : this.Mb) if (this.Mb = new G(c.lng + a * e, c.lat - b * e), 
                (a = f.yh(this.Mb, this.wb)) && g) this.Pe = a;
            },
            lf: function(a, b) {
                ...
                if (Ea(a)) if (c.Db == ua) {
                    ...
                    e.uv(function(d) {
                        if (0 == e.Wi() && 2 == e.pa.result.type) {
                            var d = d.oh(0).point, f = b || N.Qt(e.pa.content.level, c);
                            c.be(d, f);
                            ua.lh(a) && c.rv(a);
                        }
                    });
            ...
            Jj: function(a) {
                var b = this.G.tc, c = this.G.Zc, d = o;
                a < b && (d = i, a = b);
                a > c && (d = i, a = c);
                return {
                    zoom: a,
            ...
            xN: function(a, b) {
                var c = this, d = map.wb;
                c.Db == ua && d && Ka.Yy(a, c, function(a) {
                    a.x -= c.offsetX;
                    a.y -= c.offsetY;
                    b && b(a);
                });
            ...
            xg: function(a) {
                ...
                var b = a || {}, a = b.margins || [ 0, 0, 0, 0 ], c = b.zoom || n, b = this.Va({
                    x: a[3],
                    y: this.height - a[2]
                }, c), a = this.Va({
                    x: this.width - a[1],
            ...
            Ip: function(a, b) {
                ...
                for (var b = b || {}, e = [], f = 0, g = d.length; f < g; f++) e.push(this.bd.ej(d[f], this.wb));
                d = new La();
                for (f = e.length - 1; 0 <= f; f--) d.extend(e[f]);
                if (d.Bg()) return c;
                c = d.Da();
                e = this.gE(d, b);
                b.margins && (d = b.margins, f = (d[1] - d[3]) / 2, d = (d[0] - d[2]) / 2, g = this.ha().Ib(e), 
            ...
            gr: function() {
                var a = this.uh() ? this.Db.k.cJ : this.Db.lk(), b = this.uh() ? this.Db.k.bJ : this.Db.Ti(), c = this.G;
                c.tc = c.cC || a;
                c.Zc = c.bC || b;
                c.tc < a && (c.tc = a);
                c.Zc > b && (c.Zc = b);
            ...
            BB: function(a) {
                if (a) {
                    if (a.styleId) this.Yz(a.styleId); else {
                        this.G.rc = a;
                    ...
                    a.style && (a = this.G.Gf[a.style] ? this.G.Gf[a.style].backColor : this.G.Gf.normal.backColor, 
            ...
            Kb: function() {
                var a = this.T() >= this.G.hC && this.ha() == sa && 18 >= this.T(), b = o;
                try {
        ...
        function ab(a) {
            var b = Ga();
            b >= a.ur ? (Da(a.k.va) && a.k.va(a.k.fe(1)), Da(a.k.finish) && a.k.finish(), 0 < a.ge.length && (b = a.ge[0], 
            b.ge = [].concat(a.ge.slice(1)), b.start())) : (a.oq = a.k.fe((b - a.Rn) / a.k.duration), 
            Da(a.k.va) && a.k.va(a.oq), a.Dv || (a.bm = setTimeout(function() {
                ab(a);
            }, 1e3 / a.k.Vc)));
        }
        Ya.prototype.stop = function(a) {
            this.Dv = i;
            for (var b = 0; b < this.ge.length; b++) this.ge[b].stop(), this.ge[b] = n;
            this.ge.length = 0;
        ...
        function ob(a) {
            ...
            do c = nb.indexOf(a.charAt(j++)), d = nb.indexOf(a.charAt(j++)), f = nb.indexOf(a.charAt(j++)), 
            g = nb.indexOf(a.charAt(j++)), c = c << 2 | d >> 4, d = (d & 15) << 4 | f >> 2, 
        ...
        (function() {
            ...
            function b(a, b) {
                if (a.length === +a.length) for (var c = 0, d = a.length; c < d && b.call(aa, c, a[c], a) !== o; c++) ; else for (c in a) if (a.hasOwnProperty(c) && b.call(aa, c, a[c], a) === o) break;
            }
            var c = [], d = {
                push: function(a) {
                    c.push(a);
        ...
        t.object.extend(H, {
            ...
            rK: function(a, b) {
                ...
                c.Ec = this.Hg.Uk;
                for (var e = 0, f = c.Sn.length; e < f; e++) c.Sn[e]();
                c.Sn.length = 0;
            },
            Py: function(a, b) {
                var c = this;
            ...
            om: function(a) {
                this.zc.bi[a] || (this.zc.bi[a] = {}, this.zc.bi[a].Ec = this.Hg.Yv, this.zc.bi[a].Sn = []);
                return this.zc.bi[a];
            },
            remove: function(a) {
                delete this.om(a);
            ...
            UG: function(a, b) {
                for (var c = this.zc.Io, d = i, e = 0, f = c.length; e < f; e++) "" == c[e].Nu && (c[e].SA == a ? c[e].Nu = b : d = o);
                d && this.yz();
            },
            yz: function() {
                for (var a = this.zc.Io, b = 0, c = a.length; b < c; b++) this.rK(a[b].SA, a[b].Nu);
                this.zc.Io.length = 0;
            }
        });
        function O(a, b) {
        ...
        function Na(a, b) {
            a && (this.sb = a, this.M = "spot" + Na.M++, b = b || {}, this.ng = b.text || "", 
            this.yo = b.offsets ? b.offsets.slice(0) : [ 5, 5, 5, 5 ], this.ny = b.userData || n, 
            this.yf = b.minZoom || n, this.Zd = b.maxZoom || n);
        }
        Na.M = 0;
        ...
        t.extend(R.prototype, {
            initialize: function(a) {
                this.A = a;
                if (this.C) return a.ya.appendChild(this.C), this.C;
            },
            Wd: function(a) {
            ...
            Nb: function(a) {
                ...
                this.k.anchor = a;
                if (this.C) {
                    var c = this.C, d = this.k.ia.width, e = this.k.ia.height;
        ...
        t.object.extend(yb.prototype, {
            ...
            Uo: function(a) {
                if (a && Ca(a.id) && !isNaN(a.id)) {
                    ...
                    for (c in a) b[c] = a[c];
                    if (a = this.Qi(a.id)) for (var d in b) a[d] = b[d]; else this.ib.push(b);
                }
            },
            Qi: function(a) {
                for (var b = 0, c = this.ib.length; b < c; b++) if (this.ib[b].id == a) return this.ib[b];
            },
            Ut: s("ib"),
            fv: function(a) {
                for (var b = 0, c = this.ib.length; b < c; b++) this.ib[b].id == a && (r = this.ib.splice(b, 1), 
                b--, c = this.ib.length);
            },
            kd: function() {
                var a = this;
        ...
        t.object.extend(Db.prototype, {
            ...
            Xo: function(a) {
                if (a && !("menuitem" != a.tb || "" == a.ng || 0 >= a.lG)) {
                    for (var b = 0, c = this.fa.length; b < c; b++) if (this.fa[b] === a) return;
                    this.fa.push(a);
                    this.$d.push(a);
                }
            },
            removeItem: function(a) {
                if (a && "menuitem" == a.tb) {
                    for (var b = 0, c = this.fa.length; b < c; b++) this.fa[b] === a && (this.fa[b].remove(), 
                    this.fa.splice(b, 1), c--);
                    b = 0;
                    for (c = this.$d.length; b < c; b++) this.$d[b] === a && (this.$d[b].remove(), this.$d.splice(b, 1), 
                    c--);
                }
            },
            Js: function() {
            ...
            hv: function(a) {
                if (this.md[a]) {
                    for (var b = 0, c = this.fa.length; b < c; b++) this.fa[b] && "divider" == this.fa[b].tb && this.fa[b].Mg == a && (this.fa.splice(b, 1), 
                    c--), this.fa[b] && "divider" == this.fa[b].tb && this.fa[b].Mg > a && this.fa[b].Mg--;
                    this.md.splice(a, 1);
                }
            },
            vd: s("C"),
        ...
        function La(a, b) {
            ...
            a && (this.oi = new G(a.lng, a.lat), this.ei = new G(b.lng, b.lat), this.td = a.lng, 
            this.sd = a.lat, this.qd = b.lng, this.od = b.lat);
        }
        t.object.extend(La.prototype, {
            ...
            mA: function(a) {
                ...
                var b = Math.max(this.td, a.td), c = Math.min(this.qd, a.qd), d = Math.max(this.sd, a.sd), a = Math.min(this.od, a.od);
        ...
        t.extend(P, {
            sC: 6370996.81,
            aw: [ 12890594.86, 8362377.87, 5591021, 3481989.83, 1678043.12, 0 ],
            Mn: [ 75, 60, 45, 30, 15, 0 ],
        ...
        t.extend(P.prototype, {
            ...
            ob: function(a, b, c, d, e) {
                if (a) return a = this.ej(a, e), b = this.Ib(b), new O(Math.round((a.lng - c.lng) / b + d.width / 2), Math.round((c.lat - a.lat) / b + d.height / 2));
            },
            Va: function(a, b, c, d, e) {
                if (a) return b = this.Ib(b), this.yh(new G(c.lng + b * (a.x - d.width / 2), c.lat - b * (a.y - d.height / 2)), e);
            },
            Ib: function(a) {
        ...
        t.extend(Ma.prototype, {
            ...
            lngLatToPointFor3D: function(a, b) {
                ...
                H.load("coordtrans", function() {
                    var a = Gb.fu(c.at || "bj", d), a = new O(a.x, a.y);
                    b && b(a);
                }, i);
            },
            pointToLngLatFor3D: function(a, b) {
                var c = this, d = new G(a.x, a.y);
                H.load("coordtrans", function() {
                    var a = Gb.eu(c.at || "bj", d), a = new G(a.lng, a.lat), a = P.mb(a);
                    b && b(a);
                }, i);
            },
            kD: function(a, b) {
        ...
        B.xd(function(a) {
            ...
            a.addEventListener("addoverlay", function(a) {
                a = a.target;
                if (a instanceof Q) b.ga[a.M] || (b.ga[a.M] = a); else {
                    for (var d = o, e = 0, f = b.ld.length; e < f; e++) if (b.ld[e] === a) {
                        d = i;
                        break;
                    }
                    d || b.ld.push(a);
            ...
            a.addEventListener("removeoverlay", function(a) {
                a = a.target;
                if (a instanceof Q) delete b.ga[a.M]; else for (var d = 0, e = b.ld.length; d < e; d++) if (b.ld[d] === a) {
                    b.ld.splice(d, 1);
                    break;
                }
            });
            a.addEventListener("clearoverlays", function() {
                ...
                a = 0;
                for (var d = b.ld.length; a < d; a++) b.ld[a].jh != o && (b.ld[a].remove(), b.ld[a] = n, 
                b.ld.splice(a, 1), a--, d--);
            });
        ...
        function Jb(a) {
            ...
            if (0 > this.z.Ce || 1 < this.z.Ce) this.z.Ce = .65;
            if (0 > this.z.Ni || 1 < this.z.Ni) this.z.Ni = .65;
        ...
        Jb.Bp = function(a) {
            var b = [];
            if (!a) return b;
            Ea(a) && t.Qb.Fc(a.split(";"), function(a) {
                a = a.split(",");
        ...
        t.extend(Kb.prototype, {
            ...
            EK: function(a, b) {
                ...
                this.K && (this.K.style.width = this.z.width + "px", this.K.style.height = this.z.height + "px", 
                this.draw());
            }
        });
        function Lb(a, b, c) {
        ...
        Q.prototype.oc = function() {
            this.map && this.map.F.Xh && (this.map.F.Xh.zb = o, t.lang.mp(this.map.F.Xh.M), 
            this.map.F.Xh = n);
        };
        function Nb(a, b) {
            Q.call(this);
        ...
        function Qb(a, b) {
            Jb.call(this, b);
            b = b || {};
            this.z.Ni = b.fillOpacity ? b.fillOpacity : .65;
        ...
        t.extend(Qb.prototype, {
            ...
            rj: function(a, b) {
                this.Xj[a] && (this.Xj[a] = new G(b.lng, b.lat), this.$[a] = new G(b.lng, b.lat), 
                0 == a && !this.$[0].bb(this.$[this.$.length - 1]) && (this.$[this.$.length - 1] = new G(b.lng, b.lat)), 
                this.nf());
            },
            Xc: function() {
                var a = this.Xj;
        ...
        t.extend(Tb.prototype, {
            ...
            eo: function(a, b) {
                ...
                for (var c = [], d = b / 6378800, e = Math.PI / 180 * a.lat, f = Math.PI / 180 * a.lng, g = 0; 360 > g; g += 9) {
                    var j = Math.PI / 180 * g, k = Math.asin(Math.sin(e) * Math.cos(d) + Math.cos(e) * Math.sin(d) * Math.cos(j)), j = new G(((f - Math.atan2(Math.sin(j) * Math.sin(d) * Math.cos(e), Math.cos(d) - Math.sin(e) * Math.sin(k)) + Math.PI) % (2 * Math.PI) - Math.PI) * (180 / Math.PI), k * (180 / Math.PI));
                    c.push(j);
                }
                d = c[0];
        ...
        t.extend(Vb.prototype, {
            ...
            qk: function(a, b, c) {
                var d = this.map, e = d.ha(), f = d.oa, g = d.Mb, j = e.Ib(f), k = this.Jz(), l = k[0], m = k[1], q = k[2], u = k[3], v = k[4], c = "undefined" != typeof c ? c : 0, e = e.k.Bb, k = d.M.replace(/^TANGRAM_/, "");
                ...
                l = 0;
                for (d = a.childNodes.length; l < d; l++) w = a.childNodes[l], w.qx = o, this.wi.push(w);
                if (l = this.Ru) for (var x in l) delete l[x]; else this.Ru = {};
                ...
                l = 0;
                for (d = this.wi.length; l < d; l++) q = this.wi[l], q.qx || this.xi.push(q);
                this.Fv = [];
                w = (e + c) * this.map.G.devicePixelRatio;
                l = 0;
                for (d = this.Wf.length; l < d; l++) x = this.Wf[l][0], j = this.Wf[l][1], u = x * e + g[0] - c / 2, 
                v = (-1 - j) * e + g[1] - c / 2, z = k + "_" + b + "_" + x + "_" + j + "_" + f, 
                m = this.Ru[z], q = n, m ? (q = m.style, q.left = u + "px", q.top = v + "px", m.He || this.Fv.push([ x, j, m ])) : (0 < this.xi.length ? (m = this.xi.shift(), 
                m.getContext("2d").clearRect(-c / 2, -c / 2, w, w), q = m.style) : (m = document.createElement("canvas"), 
                q = m.style, q.position = "absolute", q.width = e + c + "px", q.height = e + c + "px", 
                this.vA() && (q.WebkitTransform = "scale(1.001)"), m.setAttribute("width", w), m.setAttribute("height", w), 
                a.appendChild(m)), m.id = z, q.left = u + "px", q.top = v + "px", -1 < z.indexOf("bg") && (u = "#F3F1EC", 
                this.map.G.rc && this.map.G.rc.style && (u = this.map.G.Gf[this.map.G.rc.style].backColor), 
                q.background = u ? u : ""), this.Fv.push([ x, j, m ])), m.style.visibility = "";
                l = 0;
            ...
            Jz: function() {
                var a = this.map, b = a.ha(), c = a.oa;
                b.Ib(c);
                var c = b.aA(c), d = a.Mb, e = Math.ceil(d.lng / c), f = Math.ceil(d.lat / c), b = b.k.Bb, c = [ e, f, (d.lng - e * c) / c * b, (d.lat - f * c) / c * b ];
                return [ c[0] - Math.ceil((a.width / 2 - c[2]) / b), c[1] - Math.ceil((a.height / 2 - c[3]) / b), c[0] + Math.ceil((a.width / 2 + c[2]) / b), c[1] + Math.ceil((a.height / 2 + c[3]) / b), c ];
            },
            YK: function(a, b, c, d) {
                var e = this;
                e.uM = b;
                var f = this.map.ha(), g = e.nu(a, c), j = f.k.Bb, b = [ a[0] * j + b[0], (-1 - a[1]) * j + b[1] ], k = this.ve[g];
                k && k.Wa ? (bb(k.Wa, b), d && (d = new O(a[0], a[1]), f = this.map.G.rc ? this.map.G.rc.style : "normal", 
                d = c.getTilesUrl(d, a[2], f), k.loaded = o, Yb(k, d)), k.loaded ? this.Ge() : Zb(k, function() {
                    e.Ge();
                })) : (k = this.sg[g]) && k.Wa ? (c.hb.insertBefore(k.Wa, c.hb.lastChild), this.ve[g] = k, 
                bb(k.Wa, b), d && (d = new O(a[0], a[1]), f = this.map.G.rc ? this.map.G.rc.style : "normal", 
                d = c.getTilesUrl(d, a[2], f), k.loaded = o, Yb(k, d)), k.loaded ? this.Ge() : Zb(k, function() {
                    e.Ge();
                })) : (k = j * Math.pow(2, f.Ti() - a[2]), new G(a[0] * k, a[1] * k), d = new O(a[0], a[1]), 
                f = this.map.G.rc ? this.map.G.rc.style : "normal", d = c.getTilesUrl(d, a[2], f), 
                k = new $b(this, d, b, a, c), Zb(k, function() {
                    e.Ge();
                }), ac(k), this.ve[g] = k);
            },
            Ge: function() {
            ...
            bf: function(a) {
                var b = this;
                if (b.map.ha() == ua) H.load("coordtrans", function() {
                ...
                for (var b = this.yk.concat(this.ee), c = b.length, d = 0; d < c; d++) {
                    ...
                    if (e.ap) {
                        ...
                        if (this.map.Kb()) {
                            ...
                            continue;
                        } else f.style.display = "block", this.Cd.style.display = "none", this.map.dispatchEvent(new L("vectorchanged"), {
                            isvector: o
                        });
                    }
                    if (!(e.wk && !this.map.Kb() || e.uA && this.map.Kb())) {
                        var l = this.map, m = l.ha(), f = m.Vi(), j = l.oa, q = l.Mb;
                        m == ua && q.bb(new G(0, 0)) && (q = l.Mb = f.ej(l.Pe, l.wb));
                        var u = m.Ib(j), j = m.aA(j), f = Math.ceil(q.lng / j), g = Math.ceil(q.lat / j), v = m.k.Bb, j = [ f, g, (q.lng - f * j) / j * v, (q.lat - g * j) / j * v ], k = j[0] - Math.ceil((l.width / 2 - j[2]) / v), f = j[1] - Math.ceil((l.height / 2 - j[3]) / v), g = j[0] + Math.ceil((l.width / 2 + j[2]) / v), w = 0;
                        m === ua && 15 == l.T() && (w = 1);
                        m = j[1] + Math.ceil((l.height / 2 + j[3]) / v) + w;
                        this.Ey = new G(q.lng, q.lat);
                        var z = this.ve, v = -this.Ey.lng / u, w = this.Ey.lat / u, u = [ Math.ceil(v), Math.ceil(w) ], q = l.T(), E;
                        for (E in z) {
                            var x = z[E], I = x.info;
                            (I[2] != q || I[2] == q && (k > I[0] || g <= I[0] || f > I[1] || m <= I[1])) && this.Kp(x);
                        }
                        z = -l.offsetX + l.width / 2;
                        x = -l.offsetY + l.height / 2;
                        e.hb && (e.hb.style.left = Math.ceil(v + z) - u[0] + "px", e.hb.style.top = Math.ceil(w + x) - u[1] + "px");
                        v = [];
                        for (l.Gs = []; k < g; k++) for (w = f; w < m; w++) v.push([ k, w ]), l.Gs.push({
                            x: k,
                            y: w
                        });
                        v.sort(function(a) {
            ...
            Ne: function(a) {
                ...
                if (c instanceof Ja) a && !c.cj && (c.la(this.map, this.Cd), c.cj = i); else if (c.De && this.map.Ne(c.De), 
                c.wk) {
            ...
            hf: function(a) {
                ...
                if (a instanceof Ja) b && a.cj && (a.remove(), a.cj = o); else {
                    a.De && this.map.hf(a.De);
                    if (a.wk) for (var b = 0, c = this.Ee.length; b < c; b++) a == this.Ee[b] && this.Ee.splice(b, 1); else {
                        b = 0;
            ...
            Eg: function() {
                for (var a = this.yk, b = 0, c = a.length; b < c; b++) a[b].remove();
                delete this.hb;
                this.yk = [];
                this.sg = this.ve = {};
                this.Mp();
        ...
        function bc(a) {
            if (a) {
                ...
                if (b) {
                    d = b.length;
                    for (c = 0; c < d; c += 1) e = b[c].name, Da(a[e]) && (a[e] = n);
                }
                if (b = a.children) {
                    d = b.length;
        ...
        t.extend(Wb.prototype, {
            ...
            getTilesUrl: function(a, b) {
                var c = "";
                this.Ak.tileUrlTemplate && (c = this.Ak.tileUrlTemplate.replace(/\{X\}/, a.x), c = c.replace(/\{Y\}/, a.y), 
                c = c.replace(/\{Z\}/, b));
                return c;
            },
            Qi: s("iH"),
        ...
        Ta.prototype.getTilesUrl = function(a, b) {
            var c = a.x, d = a.y, e = this.Dc, c = gc[Math.abs(c + d) % gc.length] + "/image?grids=" + c + "_" + d + "_" + b + "&q=" + e.jq + "&tags=" + e.An + "&filter=" + e.filter + "&sortby=" + e.yq + "&ak=" + this.Dc.ui + "&age=" + e.$o + "&format=" + e.mL;
        ...
        var sc = 2, tc = 3, uc = 0, vc = "bt", wc = "nav", xc = "walk", yc = "bl", zc = "bsl", Ac = 14, Bc = 15, Cc = 18, Dc = 20, Ec = 31;
        ...
        t.extend(ta.prototype, {
            ...
            TM: s("ZE"),
            Qd: function(a, b) {
                a != this.Qa && (this.ai = this.Qa, this.mo = this.sb, this.Qa = a, this.Sl = b || "street", 
                this.sb = n);
            },
            ea: function(a) {
            ...
            Ae: function(a) {
                this.Sa = a;
                a = this.Sa.pitch;
                "cvsRender" == this.Cl() ? (90 < a && (a = 90), -90 > a && (a = -90)) : "cssRender" == this.Cl() && (45 < a && (a = 45), 
                -45 > a && (a = -45));
                this.Sa.pitch = a;
            },
            Pc: function(a) {
        ...
        t.extend(Cb.prototype, {
            O: function() {
                function a(a) {
                    ...
                    } else b.Qa = b.ai, b.sb = b.mo, b.dispatchEvent(new L("onnoresult"));
                }
                var b = this.S, c = this;
    ...
    seajs.importStyle("#sht-bmaps-container{display: none; width: 770px; height: 550px; background: #000; position: absolute; border: 10px #e7e7e7 solid;}#sht-bmaps-container .sht-bmaps-wrap{ position: relative; height: 100%; width: 100%;}#sht-bmaps-container .bmaps-close{background: #fff; position: absolute; top:10px; right:10px; padding: 2px 5px;z-index: 3; cursor: pointer;}#sht-bmaps-container #bmaps-container{height: 100%; width: 100%; position: absolute; z-index: 2;}");
    var Bmaps = Class.create({
        initialize: function(name, arr) {
            this.name = name;
            this.arr = arr;
            this._setMaps(name, arr);
        },
        _setCenterXY: function(arr) {
            var point = new Array();
            var tmpLatitude = tmpLongitude = 0;
            $(arr).each(function(i) {
                tmpLatitude += parseFloat(arr[i]["latitude"]);
                tmpLongitude += parseFloat(arr[i]["longitude"]);
            });
            point["latitude"] = parseFloat(tmpLatitude) / arr.length;
            point["longitude"] = parseFloat(tmpLongitude) / arr.length;
            return point;
        },
        _setMaps: function(name, arr) {
            var _this = this;
            var point = this._setCenterXY(arr);
            //初始化百度地图
            ...
            $(arr).each(function(i) {
                ...
                marker.addEventListener("click", function() {
                    _this._showFullScreen("bmaps-container", arr[i]["latitude"], arr[i]["longitude"], arr[i]["infoTitle"], arr[i]["infoAdds"]);
                });
            });
        },
        _showFullScreen: function(container, latitude, longitude, infoTitle, infoAdds) {
            var _this = this;
            $("body").append('<div id="sht-bmaps-container"><div class="sht-bmaps-wrap"><span class="bmaps-close">X</span><div id="bmaps-container"></div></div></div>');
            var _scrollHeight = $(document).scrollTop(), //获取当前窗口距离页面顶部高度  
            _windowHeight = $(window).height(), //获取当前窗口高度  
            _windowWidth = $(window).width(), //获取当前窗口宽度  
            _popupHeight = $("#sht-bmaps-container").height(), //获取弹出层高度  
            _popupWeight = $("#sht-bmaps-container").width();
            //获取弹出层宽度 
            _posiTop = (_windowHeight - _popupHeight) / 2 + _scrollHeight;
            _posiLeft = (_windowWidth - _popupWeight) / 2;
            $("#sht-bmaps-container").css({
                top: _posiTop,
                left: _posiLeft
            }).show();
            $(".bmaps-close").click(function() {
                $("#bmaps-container").empty();
                $("#sht-bmaps-container").hide();
            });
            ...
            var infoWindow = new BMap.InfoWindow(infoAdds, opts);
            // 创建信息窗口对象    
            map.openInfoWindow(infoWindow, map.getCenter());
        },
        _addMarker: function(arr) {
            //创建标注
            $(arr).each(function(i) {
                var point = new BMap.Point(arr[i]["longitude"], arr[i]["latitude"]);
                var marker = new BMap.Marker(point);
                ...
                marker.addEventListener("click", function() {
                    ...
                    var opts = {
                        ...
                        height: 100,
                        // 信息窗口高度    
                        title: arr[i]["infoTitle"],
                        // 信息窗口标题 
                        enableAutoPan: true,
                        enableSendToPhone: false
                    };
                    var infoWindow = new BMap.InfoWindow(arr[i]["infoAdds"], opts);
                    // 创建信息窗口对象    
        ...
        _setBound: function(className, latitude, longitude, infoTitle, infoAdds) {
            var _this = this;
            latitude = latitude ? latitude : _this.arr[0]["latitude"];
            longitude = longitude ? longitude : _this.arr[0]["longitude"];
            infoTitle = infoTitle ? infoTitle : _this.arr[0]["infoTitle"];
            infoAdds = infoAdds ? infoAdds : _this.arr[0]["infoAdds"];
            $(className).click(function() {
                _this._showFullScreen("bmaps-container", latitude, longitude, infoTitle, infoAdds);
            });
        }
    });
    module.exports = Bmaps;
});
