define(function (require, exports, module) {
    ...
    var LoadingOverlay = Overlay.extend({
        attrs: {
            template: '<img class="ui-loading" src="http://s.shtimage.com/images/common/loading.gif">',
            zIndex: 9009,
            width: 16,
            height: 16,
            position: 'absolute',
    ...
    $.fn.mySelect = function () {
        ...
        return this.each(function () {
            ...
            if($(this).data('wclass')){
                tempObj.set('className','widget-'+$(this).data('wclass'));
            }
    ...
    $.fn.resizeImage = function (b, c) {
        return  this.each(function () {
            var d = $(this)[0],
                f = d.width,
                e = d.height;
            if (!(f <= b && e <= c)) if (f <= b && e > c) d.width = f * c / e,
                d.height = c;
            else if (f > b && e <= c) d.width = b,
                d.height = e * b / f;
            else if (d.width = b, d.height = e * b / f, e * b / f > c) d.width = f * c / e,
                d.height = c
        });
    };
    /**
