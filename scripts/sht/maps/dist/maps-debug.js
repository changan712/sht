define("sht/maps/1.0.0/maps-debug", [ "arale/class/1.1.0/class-debug", "arale/dialog/1.2.5/dialog-debug" ], function(require, exports, module) {
    ...
    var Dialog = require("arale/dialog/1.2.5/dialog-debug");
    require("arale/dialog/1.2.5/dialog-debug.css");
    var Maps = Class.create({
        initialize: function(name) {
            ...
            setLatitude = setLongitude = setInfoTitle = setInfoDesc = "";
            $(".container").after('<div id="map-container-wrap" style=" height:100%;"><div id="map-container" style=" height:100%;"></div></div>');
            this._setMap();
        },
        _setMap: function(latitude, longitude, infoTitle, infoDesc) {
            setLatitude = latitude ? latitude : this.latitude;
            setLongitude = longitude ? longitude : this.longitude;
            setInfoTitle = infoTitle ? infoTitle : this.infoTitle;
            setInfoDesc = infoDesc ? infoDesc : this.infoDesc;
            var map = new BMap.Map(this.nameID);
            // 创建地图实例  
            //var point = new BMap.Point(setLatitude, setLongitude);  // 创建点坐标  
        ...
        _showFullScreen: function(className) {
            var _this = this;
            setLatitude = setLatitude ? setLatitude : _this.latitude;
            setLongitude = setLongitude ? setLongitude : _this.longitude;
            setInfoTitle = setInfoTitle ? setInfoTitle : _this.infoTitle;
            setInfoDesc = setInfoDesc ? setInfoDesc : _this.infoDesc;
            var urlDialogObj = new Dialog({
                ...
                this.set("content", $("#map-container-wrap"));
                ...
                var infoWindow = new BMap.InfoWindow(setInfoDesc, opts);
                // 创建信息窗口对象    
